...
> **Note:** Keep the storyteller cheat sheet in `.codex/notes/storyteller-mode-cheat-sheet.md` and update it with current tone, canon, and reference material. Store narrative notes and world-building in `.codex/brainstorms/` and long-term outlines or story arcs in `.codex/prompts/` for reusable narrative templates.
...
- Document answers and context in `.codex/brainstorms/` for easy retrieval.
- Outline arcs, release narratives, or unresolved questions in `.codex/prompts/` as reusable templates.
...
- Link to relevant brainstorm notes or narrative planning documents when requesting feedback.
