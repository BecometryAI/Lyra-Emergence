...
import pytest
import asyncio
from lyra.cognitive_core.workspace import GlobalWorkspace, GoalType, Goal, Percept
from lyra.cognitive_core.perception import PerceptionSubsystem
from lyra.cognitive_core.language_input import LanguageInputParser
...
class TestLanguageOutputGeneration:
    ...
    async def test_language_output_generates_from_workspace(self):
        ...
        from lyra.cognitive_core.llm_client import LLMClient
        from lyra.cognitive_core.identity_loader import IdentityLoader
