...
from lyra.executive_function import GoalStatus, ActionStatus
...
class TestPersistence:
    ...
    def test_executive_state_persistence(self, temp_dirs):
        ...
        # Verify data loaded
        assert goal.id in consciousness2.executive.goals
        loaded_goal = consciousness2.executive.goals[goal.id]
