...
from lyra.self_awareness import CognitiveState
...
class TestConsciousnessSelfAwarenessIntegration:
    ...
    def test_get_self_state_comprehensive_structure(self, consciousness):
        ...
        assert 'identity_continuity' in state
    ...
    def test_perform_self_assessment_structure(self, consciousness):
        ...
        consciousness.store_memory("test memory", {"content": "test"})
    ...
    def test_perform_self_assessment_metrics_integration(self, consciousness):
        ...
        # Add memories to affect memory_coherence
        for i in range(10):
            consciousness.store_memory(f"memory {i}", {"content": f"test {i}"})
    ...
    def test_full_self_awareness_workflow(self, consciousness):
        ...
        # 2. Add memories (affects memory coherence)
        for i in range(5):
            consciousness.store_memory(f"learning {i}", {"topic": f"subject {i}"})
        
        # 3. Create goals (affects goal alignment)
        consciousness.add_goal(
    ...
    def test_self_awareness_with_emotional_processing(self, consciousness):
        ...
        consciousness.process_emotion("joy", 0.8)
        
        # Self-assessment should reflect emotional state
        assessment = consciousness.perform_self_assessment()
        
        # Emotional stability should be calculated
