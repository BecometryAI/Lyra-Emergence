...
class ConsciousnessCore:
    ...
    def plan_actions_for_goal(
        ...
        for i, desc in enumerate(action_descriptions):
            ...
            if dependencies and i in dependencies:
                ...
                deps = [action_ids[di] for di in dep_indices if di < i]
        ...
        logging.info(f"Planned {len(action_ids)} actions for goal {goal_id}")
        return action_ids
    ...
    def make_decision(
        ...
        selected, confidence, _ = self.executive.evaluate_decision(
            decision.id,
    ...
    def get_executive_summary(self) -> Dict[str, Any]:
        ...
        active_goals = self.get_active_goals(n=3)
