...
class DataValidator:
    ...
    def validate_directory(self, subdir: str, validator_func=None, exclude_files=None) -> Dict[str, Any]:
    ...
    def validate_all(self) -> Dict[str, Any]:
        ...
        for subdir in ['Core_Archives', 'Protocols', 'Rituals', 'Lexicon']:
            report['directories'][subdir] = self.validate_directory(subdir)
